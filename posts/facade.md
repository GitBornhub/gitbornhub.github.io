...
| vision area | 可视区 |
| spandrel area | 层间封闭区 |
| bracket | 转接件、支座、托架、角码 |
| angle bracket | 角码 |
| concealed bracket | 隐蔽式转接件 |
| adjustable bracket | 可调式转接件 |
| Z-clip and fastener | Z型卡件及紧固件 |
| soffit | 檐底封板、层间下封板 |
| interface | 封修、收口、交接处理 |
| closure plate / closure panel | 封修板 |
| aluminum formed closure | 铝成型封修弯板 |
| brake shape | 铝折弯件 |
| continuous | 通长 |
| flashing | 泛水板 |
| alu-core / alucore | 铝芯板、铝蜂窝复合板 |
| steel-aluminum composite vertical keel | 钢铝结合竖龙骨 |
| slab | 厚板（石材/混凝土） |
| sheet | 薄板材、原材薄板 |
| board | 保温板、防火板、功能基板 |
| panel | 幕墙成品装饰板块 |
...
| 英文 | 中文 |
|------|------|
| insulating glass / insulated glass | 中空玻璃 |
| insulating vision glass | 中空可视玻璃 |
| laminated glass | 夹胶玻璃、夹层玻璃 |
| laminated insulating glass | 夹胶中空玻璃 |
| insulated glass unit (IGU) | 中空玻璃组件 |
| opaque glass | 不透明玻璃 |
| transparent | 透明的 |
| translucent | 半透明的 |
| PVB | PVB夹胶胶片 |
...
| 英文 | 中文 |
|------|------|
| auto-sliding door | 自动平移门 |
| sliding door | 推拉门 |
| side-hung door | 平开门 |
| double side hung doors | 双扇平开门 |
| top-hung window / top hung vents | 上悬窗 |
| top hung lights | 上悬窗顶部固定扇 |
| opening lights | 开启扇 |
| fixed lights | 固定扇 |
| fixed window | 固定窗 |
| tilt & turn window | 内开内倒窗 |
| louver | 百叶、百叶格栅、防雨百叶 |
| perforated louver | 穿孔百叶 |

## 四、门窗五金件
| 英文 | 中文 |
|------|------|
| ironmongery | 五金件 |
| friction stay | 摩擦铰链、风撑 |
| handle | 执手 |
| deadlock | 闭锁、死锁 |
| latch | 门插销、碰锁 |
| multi-point fastening / multi-point lock | 多点锁 |
| hinge | 铰链、合页 |
| floor spring | 地弹簧 |
| door closer | 闭门器 |
...
|------|------|
| sealant | 密封胶 |
| structural sealant | 结构密封胶 |
| weatherproof sealant | 耐候密封胶 |
| sealant-back rod | 泡沫背衬条、填缝泡沫棒 |
| bed seal | 底部密封、底密封 |
| weather strip | 密封胶条（橡胶/EPDM） |
| weather stripping | 密封毛条（纤维毛刷） |
| gasket | 密封垫、密封条 |
| rubber gasket | 橡胶密封条 |
| EPDM membrane | 三元乙丙防水卷材 |
| lining | 衬板、衬垫、内衬 |
| adhesive | 胶粘剂、粘合剂 |
...
|------|------|
| bolt | 螺栓 |
| s-s bolt / stainless steel bolt | 不锈钢螺栓 |
| nut | 螺母 |
| flat washer | 平垫圈 |
| spring washer | 弹簧垫圈 |
| anchor bolt | 锚栓、锚固螺栓 |
...
| self-drilling screw | 自攻自钻钉 |
| rivet | 铆钉 |
| shear pins | 销钉、抗剪销 |
| temporary fastener | 临时紧固件 |
| reinforcement | 加固、加劲、加强筋 |
...
| wind pressure coefficient | 风压系数 |
| shape coefficient | 体型系数 |
| thermal expansion coefficient | 热膨胀系数 |
| insulation | 保温、隔热、隔声、绝缘 |
| thermal insulation | 保温 |
| heat insulation | 隔热 |
| insulation board | 保温板 |
| air tightness | 气密性 |
| water tightness | 水密性 |
| sound insulation | 隔声 |
